...
--
-- Host: localhost    Database: crm_azkell
-- ------------------------------------------------------
...
CREATE TABLE `fleetrun` (
  ...
  `tipo_mantenimiento_id` int DEFAULT NULL,
  `kilometraje_ejecucion` int DEFAULT NULL,
  ...
  `dueno` varchar(100) DEFAULT '',
  `uts` varchar(50) DEFAULT '',
  `tipo_mp` varchar(100) DEFAULT '',
  `km_actual` decimal(15,2) DEFAULT NULL,
  `frecuencia_km` decimal(15,2) DEFAULT NULL,
  `km_proximo` decimal(15,2) DEFAULT NULL,
  `km_gps` varchar(100) DEFAULT '',
  `tecnico` varchar(100) DEFAULT '',
  `observacion` text,
  PRIMARY KEY (`id`),
  UNIQUE KEY `uq_idregistro` (`idRegistro`)
) ENGINE=InnoDB AUTO_INCREMENT=9889 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `inventario` (
  ...
  `tipo` enum('Original','Alternativo') DEFAULT NULL,
...
CREATE TABLE `km_snapshots` (
  ...
  KEY `idx_placa` (`placa`),
  KEY `idx_fecha` (`fecha`)
) ENGINE=InnoDB AUTO_INCREMENT=10451 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci COMMENT='Snapshot diario de KM GPS y horas motor por placa (Wialon)';
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `tipos_mantenimiento` (
  ...
  `km_intervalo` int DEFAULT NULL,
  `dias_intervalo` int DEFAULT NULL,
  `frecuencia_dias` int DEFAULT NULL,
  `frecuencia_horas` varchar(50) DEFAULT NULL,
  `marca` varchar(100) NOT NULL DEFAULT '',
  `tipo_mp` varchar(100) NOT NULL DEFAULT '',
  `uts` varchar(50) NOT NULL DEFAULT '',
  `frecuencia_km` decimal(10,2) DEFAULT NULL,
...
--
-- Temporary view structure for view `vista_costo_por_kit`
--

DROP TABLE IF EXISTS `vista_costo_por_kit`;
/*!50001 DROP VIEW IF EXISTS `vista_costo_por_kit`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `vista_costo_por_kit` AS SELECT 
 1 AS `marca_vehiculo`,
 1 AS `tipo_mp`,
 1 AS `nombre_kit`,
 1 AS `total_items`,
 1 AS `costo_total_kit`,
 1 AS `creado_en`*/;
SET character_set_client = @saved_cs_client;

--
-- Final view structure for view `vista_costo_por_kit`
--
...
/*!50001 VIEW `vista_costo_por_kit` AS select `mantenimiento_kits`.`marca_vehiculo` AS `marca_vehiculo`,`mantenimiento_kits`.`tipo_mp` AS `tipo_mp`,`mantenimiento_kits`.`nombre_kit` AS `nombre_kit`,count(0) AS `total_items`,round(sum(`mantenimiento_kits`.`costo_total`),2) AS `costo_total_kit`,min(`mantenimiento_kits`.`created_at`) AS `creado_en` from `mantenimiento_kits` where (`mantenimiento_kits`.`activo` = 1) group by `mantenimiento_kits`.`marca_vehiculo`,`mantenimiento_kits`.`tipo_mp`,`mantenimiento_kits`.`nombre_kit` order by `mantenimiento_kits`.`marca_vehiculo`,`mantenimiento_kits`.`tipo_mp` */;
...
-- Dump completed on 2026-04-20 15:02:45
