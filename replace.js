...
// 3. f_tec
replaceBlock(
    '<input type="text" class="form-control form-control-sm text-uppercase" style="border-radius:12px;min-height:44px;" name="f_tec" id="f_tec" required>', 
    'required>', 
    `<div class="position-relative">
...
// 6. eF_tec
replaceBlock(
    '<input type="text" class="form-control form-control-sm text-uppercase" style="border-radius:12px;min-height:44px;" name="editF_tec" id="eF_tec" required>', 
    'required>', 
    `<div class="position-relative">
