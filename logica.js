...
const TIEMPO_ALERTA_INACTIVIDAD = 30 * 60 * 1000; // 30 minutos de inactividad para mostrar alerta
const TIEMPO_MAX_INACTIVIDAD    = 35 * 60 * 1000; // 35 minutos de inactividad total para cerrar sesión (5 minutos de gracia)
...
window.verificarSesionGuardada = function() {
    ...
    window.esRutaValidaYPermitida = function(r) {
        ...
        var rMap = {
            ...
            'operaciones/combustible-estaciones': 'combustible_vales',
...
function verificarInactividad() {
    ...
    // Si pasaron 35 minutos o más -> Cierre de sesión inmediato
    ...
    // Si pasaron 30 minutos o más -> Mostrar alerta de inactividad
...
const TITULOS_MODULOS = {
    ...
    'mantenimiento/checklist':        'Reporte de Fallas',
...
const MENU_IDS = {
    ...
    'mantenimiento/incidencias-ruta':  'nav-incidencias-ruta',
...
const MENU_SECTION = {
    ...
    'mantenimiento/incidencias-ruta': 'mantenimiento',
    'mantenimiento/reportes-ot':      'mantenimiento',
    'flota/disponibilidad':       'flota',
...
const BREADCRUMB_MAP = {
    ...
    'mantenimiento/incidencias-ruta': ['Mantenimiento','Incidencias en Ruta'],
...
window.exportarExcelFleetrun = function() {
    ...
    if (tbody) {
        ...
        headers.forEach(header => {
            ...
            const classPlaca = (typeof normalizarClase === 'function') ? normalizarClase(placaRaw) : placaRaw.replace(/[^A-Za-z0-9]/g, '_');
    ...
    const ws = XLSX.utils.aoa_to_sheet(ws_data);
    const wb = XLSX.utils.book_new();
    const sheetName = window.isHistorialFleetrun ? "Historial_Preventivo" : "Mantenimiento_Preventivo";
    XLSX.utils.book_append_sheet(wb, ws, sheetName);

    const fechaHoy = new Date().toISOString().slice(0, 10);
    const nombreArchivo = window.isHistorialFleetrun 
...
window.cfgSetPresetProveedor = window.cfgSetPresetProveedor || function(tipo) {
