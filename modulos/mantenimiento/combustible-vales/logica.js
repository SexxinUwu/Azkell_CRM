// ── LÓGICA DE VALES DE COMBUSTIBLE — ERP AZKELL FLEET ──────────────────────────────
(function() {
    window._cvData = [];
    ...
    window.cvRenderTabla = function() {
        ...
        window._cvData.forEach(row => {
            ...
            const pagoBadge = (row.estado_pago || '').toUpperCase() === 'PAGADO'
                ...
                : '<span class="badge rounded-pill bg-warning bg-opacity-10 text-dark fw-bold px-2 py-0.5" style="font-size:0.68rem;">NO PAGADO</span>';
    ...
    window.cvExportarExcel = async function() {
        ...
        // Obtener todos los registros filtrados sin paginar
