function verDetalleInspeccion(idBusqueda, autoDescargarPDF) {
    ...
    // Recolectores de Evidencias (Fotos)
    ...
    if(htmlFallas === "") htmlFallas = "<p class='text-center text-muted mt-3'>No hay observaciones ni fallas marcadas en este reporte.</p>";
    ...
    <div class="col-12"><div class="card p-3 shadow-sm"><h6 class="fw-bold text-primary border-bottom pb-2">Resultados (Solo respondidos)</h6><div style="max-height: 300px; overflow-y:auto; font-size: 0.9rem; color:var(--text);">${htmlFallas}</div></div></div>`;
