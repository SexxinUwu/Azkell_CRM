    ...
    const initTables = async (dbConn) => {
        try {
            ...
            const addCols = [
                ...
                "ALTER TABLE guias_remision ADD COLUMN foto_evidencia LONGTEXT DEFAULT NULL",
                "ALTER TABLE guias_remision MODIFY COLUMN foto_evidencia LONGTEXT DEFAULT NULL",
